  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        "block-blue": "hsl(var(--block-blue) / <alpha-value>)",
        "block-beige": "hsl(var(--block-beige) / <alpha-value>)",
        "block-terracotta": "hsl(var(--block-terracotta) / <alpha-value>)",
        "block-yellow": "hsl(var(--block-yellow) / <alpha-value>)",
